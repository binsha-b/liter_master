...
const getIcon = label => {
  if (label === 'Sales') {
    return require('../assets/icons/salespng.png');
  }
  if (label === 'Fuel Order') {
    return require('../assets/icons/fuelOrderpng.png');
  }
  if (label === 'Incident Report') {
    return require('../assets/icons/reportpng.png');
  }
  if (label === 'FMR') {
    return require('../assets/icons/fmrpng.png');
  }
  if (label === 'Account') {
